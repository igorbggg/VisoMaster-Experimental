@echo off
REM DEPRECATED: requirements_cu118.txt is no longer maintained. Use requirements_cu129.txt instead.
echo WARNING: update_cu118.bat is deprecated. Use scripts\update_cu129.bat or scripts\ubuntu\update.sh
